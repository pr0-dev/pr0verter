...
export default function Finished(props) {
    return (
        <>
            ...
            <div className="bg-pr0-bg w-full min-h-screen pb-8">
                <Navigation/>
                ...
                <a href={route("downloadConversion", props.conversion.guid)}><Button className={"w-1/4 mx-auto mt-6"}>Herunterladen</Button></a>
            </div>
        </>
    );
}
