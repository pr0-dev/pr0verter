...
return [
    ...
    /** Maximum Result (Default 400 MB) */
    'maxResultSize' => env('MAX_RESULT_SIZE', 400),
    /** Maximum Result lenght (Default 299 Seconds (1 Second Spare)) */
    ...
    'maxResultAudioBitrate' => env('MAX_RESULT_AUDIO_BITRATE', 128),
